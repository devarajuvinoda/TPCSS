 ...
 *
 * To compile, first check that your machine has the libpcap-dev library
 * installed on it, or install it as described on the homework handout.
 * Then compile using ``gcc -lpcap''
 *
 */
